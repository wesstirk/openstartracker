...
class nonstar:
	...
	def __del__(self):
		try :
			...
			print("In the nonstar descructor!")
			print("Tried to write to {} but an exception was received!".format(NONSTAR_DATAFILE))
			print(e)
...
if __name__ == '__main__' :
	...
	parser.add_argument("configFile", help="The name of the configuration file")
	parser.add_argument("year", help="The year?", type=float)
	parser.add_argument("medianImage", help="A median image?")
	parser.add_argument("solveImage", help="The image to solve")
